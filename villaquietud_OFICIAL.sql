...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-03-2021 a las 22:51:23
...
(3, '2021-03-08 19:03:20', 4, 2019, 587, 1, 19, 'asdasd'),
(4, '2021-03-08 19:03:20', 3, 2020, 8998, 1, 19, 'asdasd'),
(5, '2021-03-09 22:03:24', 3, 2021, 4500, 1, 18, 'Manuel Canul'),
(6, '2021-03-09 20:03:54', 3, 2021, 20000, 1, 19, 'Manuel Canul');
...
CREATE TABLE `egresos` (
  ...
  `concepto_egreso` text COLLATE utf8_spanish_ci NOT NULL,
  `cantidad_egreso` double NOT NULL,
  `fecha_egreso` date NOT NULL,
  `nota_egreso` text COLLATE utf8_spanish_ci NOT NULL,
  `status_egreso` int(1) NOT NULL COMMENT '1: ACTIVO, 2: INACTIVO',
  `id_usuario` int(11) NOT NULL
...
(2, 'Intel  Xeon E3-1225v2', 2, '2021-03-09 20:03:54', 19);
...
(24, 'cris@gmail.com', 'cris@gmail.com', '0ee401cb0470a7419e116d1b0b56d507', 1, '9876543210'),
(25, 'cris@gmail.com', 'layuso@gmail.com', 'fd934c6587f6d801aa940a801fec7107', 2, '9991714216'),
(26, 'dmartinez@modelo.edu.mx', 'dmartinez@modelo.edu.mx', '698c0393413f2e40a59ad37d7e3eb996', 3, '9991714216');
