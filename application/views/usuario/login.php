                ...
                <div class="card card-body my-3">
                    <form action="index.php/usuario/login" method="POST">
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" id="" placeholder="nombre@correo.com" class="form-control" require>
                        </div>
                        <div class="mb-3">
                        ...
                        <a href="index.php/usuario/forgot"> <p class="text-center">Olvide mi contraseña</p></a>
                    </form>
                </div>
                <?php
                if ($ban == 1){
                echo'<div class="alert alert-danger mb-3 text-center" role="alert">
