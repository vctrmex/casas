...
<head>
	...
	<!-- plugins:css -->
	<link rel="stylesheet"
		href="<?php echo base_url('resources/'); ?>assets/vendors/iconfonts/mdi/css/materialdesignicons.min.css">
	<link rel="stylesheet"
		href="<?php echo base_url('resources/'); ?>assets/vendors/iconfonts/ionicons/dist/css/ionicons.css">
	<link rel="stylesheet"
		href="<?php echo base_url('resources/'); ?>assets/vendors/iconfonts/flag-icon-css/css/flag-icon.min.css">
...
<body>
	<div class="container-scroller">
		...
		<div class="container-fluid page-body-wrapper">
          ...
          <li class="nav-item">
						<a class="nav-link" href="<?php echo base_url('Usuario/balanceDeIngresosEgresos'); ?>">
							<i class="menu-icon typcn typcn-user-outline"></i>
			...
			<div class="main-panel">
				...
				<footer class="footer">
					<div class="container-fluid clearfix">
						<span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © villaquietud.com
							2020</span>
					</div>
				</footer>
				<!-- partial -->
